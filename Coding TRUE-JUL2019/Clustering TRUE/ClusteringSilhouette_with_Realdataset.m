...
load synResultsClustering_RealdataUCI_20Dataset_16JUL2019-2.mat
...
OTBRealUCI20(ddset,:) = table(DataName,KBest,Score,IDX,Centroid,Jaccard,AdjustRand,FM,Rand,StartDate);

ddset

end

save('Clustering Projects/Results TRUE-JUL2019/Results Clustering-TRUE/synResultsSilhouetteClu1_Realdataset20_16JUL2019.mat','OTBRealUCI20');
