...
for ddset=1:20
    ...
    %nametable=data(ddset,1);
     % cutN = countcell(datasyn,ddset);
   % N = size(datasyn{ddset,:}); %view size data
  %  cutN = (N(2)-1);
%     N = size(datasyn);
%     cutN = (N(2)-1);
...
save('Clustering Projects/Results TRUE-AUG2019/Dataset Clustering - TRUE/synResultsClustering_RealdataUCI_20Dataset_12SEP2019-1.mat','dataUCIRealAll20ds');
